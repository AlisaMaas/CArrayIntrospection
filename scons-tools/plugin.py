...
__run_plugin_builder = Builder(
    ...
    '/home/ajmaas/sra/llvm-3.5.1.src/lib/Transforms/llvm-sra/SAGE/bin/sage-opt ' + 
    '-load Python.so -load SAGE.so -load SRA.so -analyze ' + 
    '$_RUN_PLUGIN_SOURCE_ARGS $PLUGIN_ARGS -test-$TEST=$TARGET',
